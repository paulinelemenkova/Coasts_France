...
The French coastline extends across the English Channel, Atlantic Ocean, and Mediterranean Sea, encompassing a wide range of coastal geomorphologies, climatic conditions, and land use patterns. With a total length of approximately 5,853~km (metropolitan France), it constitutes one of the longest and most geomorphologically diverse coastlines in Western Europe \citep{clave2021littoraux}, \textcolor{blue}{Figure} \ref{fig:overview}. 
