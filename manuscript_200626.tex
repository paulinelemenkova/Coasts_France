...
Southern &
Mediterranean &
Lagoon / Urban, containing low-lying sandy beaches, coastal wetlands, rocky calanques \textcolor{blue}{(steep-sided limestone inlets)}, and steep cliffs. &
...
\textcolor{blue}{The complete sequence of processing operations, from Sentinel-2 data import through classification, change detection, and statistical analysis, is summarized in Figure~\ref{fig:workflow}.}

\begin{figure}[H]
\centering
\includegraphics[width=13.0cm]{Figure_workflow.png}
...
\begin{figure}[H]
\centering
	\hspace{-35pt}\includegraphics[width=10.0cm]{Figure_04.png}
...
Regional comparisons were conducted using trend analysis and spatial statistics to evaluate and contextualize differences in coastal dynamics. \textcolor{blue}{The overall analytical framework adopted for this regional comparison is summarized in Figure~\ref{fig:framework}.} The Mann--Kendall trend test was applied to annual normalized difference vegetation index (NDVI) time series derived from all available Sentinel-2 scenes between 2015 and 2025 (not restricted to summer months) to detect monotonic greening or browning trends at pixel level. Spatial autocorrelation of change magnitude was assessed using Moran's~$I$ index computed on the change intensity raster for each region, providing a measure of spatial clustering of dynamic zones.
...
\caption{\textcolor{blue}{Comparative dynamics among the northern, western, and southern French coastal regions: Sankey diagram of the dominant land cover transitions 2015--2025, with a land-cover colour scheme across the three regions. Diagram software: Python (Plotly library v. 6.8.0). Source: author.}}
...
\subsection{\textcolor{blue}{Key Findings}}
...
\subsection{\textcolor{blue}{Scientific Contribution}}
