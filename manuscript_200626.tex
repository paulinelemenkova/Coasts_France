...
\begin{figure}[H]
\centering
	\hspace{-35pt}\includegraphics[width=13.5cm]{Figure_01.png}
...
\caption{\textcolor{blue}{Comparative dynamics among the northern, western, and southern French coastal regions: Sankey diagram of the dominant land cover transitions between 2015 and 2025, with a consistent land-cover colour scheme across the three regions. Diagram software: Python (Matplotlib). Source: author.}}
