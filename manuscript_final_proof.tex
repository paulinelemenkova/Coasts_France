...
%MDPI: Please add the page number. %AUTHOR: Territoire en mouvement is an online-only journal; this article (issue 30, 2016) has no page numbers. The DOI (10.4000/tem.3344) serves as the article identifier.
...
\newblock {\em Territ. Mouv.} {\bf 2016}, {\em 30}.
\newblock {\url{https://doi.org/10.4000/tem.3344}}.

%MDPI: Please add the url. %AUTHOR: The URL has been added: https://www.observatoire-cote-aquitaine.fr/Le-littoral-de-Charente-Maritime-173
...
\newblock Le littoral de Charente-Maritime, 2024. Available online:
  \url{https://www.observatoire-cote-aquitaine.fr/Le-littoral-de-Charente-Maritime-173}
  (accessed on 17 May~2026).
...
\bibitem[Castelle et~al.(2015)Castelle, Marieu, Bujan, Splinter, Robinet, S\'en\'echal, and Ferreira]{castelle2018aquitaine}
Castelle, B.; Marieu, V.; Bujan, S.; Splinter, K.D.; Robinet, A.; S\'en\'echal, N.; Ferreira, S.
\newblock Impact of the winter 2013--2014 series of severe {W}estern {E}urope
  storms on a double-barred sandy coast: {B}each and dune erosion and megacusp
  embayments.
\newblock {\em Geomorphology} {\bf 2015}, {\em 238},~135--148.
\newblock {\url{https://doi.org/10.1016/j.geomorph.2015.03.006}}.
...
%MDPI: Refs. 37 and 47 are duplicated. Please remove duplicated references and rearrange all the references so that they appear in numerical order. Please ensure that there are no duplicated references. %AUTHOR: The duplication has been removed---the former Ref. 47 now cites a different source (Griffiths et al., 2019), so this reference appears only once. All references have been checked for duplicates and are listed in order of citation.
...
Drusch, M.; Del~Bello, U.; Carlier, S.; Colin, O.; Fernandez, V.; Gascon, F.;
  Hoersch, B.; Isola, C.; Laberinti, P.; Martimort, P.; et~al.
\newblock Sentinel-2: {ESA}'s Optical High-Resolution Mission for {GMES}
  Operational Services.
\newblock {\em Remote Sens. Environ.} {\bf 2012}, {\em 120},~25--36.
...
\bibitem[Corbane et~al.(2021)Corbane, Syrris, Sabo, Politis, Melchiorri, Pesaresi, Soille, and Kemper]{soille2018urban}
Corbane, C.; Syrris, V.; Sabo, F.; Politis, P.; Melchiorri, M.; Pesaresi, M.; Soille, P.; Kemper, T.
\newblock Convolutional neural networks for global human settlements mapping
  from {Sentinel-2} satellite imagery.
\newblock {\em Neural Comput. Appl.} {\bf 2021}, {\em 33},~6697--6720.
\newblock {\url{https://doi.org/10.1007/s00521-020-05449-7}}.
...
\bibitem[Vos et~al.(2019)Vos, Splinter, Harley, Simmons, and Turner]{castelle2021shoreline}
Vos, K.; Splinter, K.D.; Harley, M.D.; Simmons, J.A.; Turner, I.L.
\newblock {CoastSat}: {A} {Google Earth Engine}-enabled {Python} toolkit to
  extract shorelines from publicly available satellite imagery.
\newblock {\em Environ. Model. Softw.} {\bf 2019}, {\em 122},~104528.
\newblock {\url{https://doi.org/10.1016/j.envsoft.2019.104528}}.

\bibitem[Griffiths et~al.(2019)Griffiths, Nendel, and Hostert]{drusch2012sentinel}
Griffiths, P.; Nendel, C.; Hostert, P.
\newblock Intra-annual reflectance composites from {Sentinel-2} and {Landsat}
  for national-scale crop and land cover mapping.
\newblock {\em Remote Sens. Environ.} {\bf 2019}, {\em 220},~135--151.
\newblock {\url{https://doi.org/10.1016/j.rse.2018.10.031}}.
...
\bibitem[Bolton et~al.(2020)Bolton, Gray, Melaas, Moon, Eklundh, and
  Friedl]{jamet2019harmonic}
Bolton, D.K.; Gray, J.M.; Melaas, E.K.; Moon, M.; Eklundh, L.; Friedl, M.A.
\newblock Continental-scale land surface phenology from harmonized {Landsat 8}
  and {Sentinel-2} imagery.
\newblock {\em Remote Sens. Environ.} {\bf 2020}, {\em 240},~111685.
\newblock {\url{https://doi.org/10.1016/j.rse.2020.111685}}.
...
\bibitem[Ludwig et~al.(2019)Ludwig, Walli, Schleicher, Weichselbaum, and
  Riffler]{gaudart2021zones}
Ludwig, C.; Walli, A.; Schleicher, C.; Weichselbaum, J.; Riffler, M.
\newblock A highly automated algorithm for wetland detection using
  multi-temporal optical satellite data.
\newblock {\em Remote Sens. Environ.} {\bf 2019}, {\em 224},~333--351.
\newblock {\url{https://doi.org/10.1016/j.rse.2019.01.017}}.
...
\bibitem[Slagter et~al.(2020)Slagter, Tsendbazar, Vollrath, and
  Reiche]{berhault2020sentinel}
Slagter, B.; Tsendbazar, N.E.; Vollrath, A.; Reiche, J.
\newblock Mapping wetland characteristics using temporally dense {Sentinel-1}
  and {Sentinel-2} data: {A} case study in the {St. Lucia} wetlands, {South
  Africa}.
\newblock {\em Int. J. Appl. Earth Obs. Geoinf.} {\bf 2020}, {\em 86},~102009.
\newblock {\url{https://doi.org/10.1016/j.jag.2019.102009}}.
...
\bibitem[Gomes et~al.(2020)Gomes, Queiroz, and Ferreira]{camara2020open}
Gomes, V.C.F.; Queiroz, G.R.; Ferreira, K.R.
\newblock An Overview of Platforms for Big Earth Observation Data Management and
  Analysis.
\newblock {\em Remote Sens.} {\bf 2020}, {\em 12},~1253.
\newblock {\url{https://doi.org/10.3390/rs12081253}}.

\bibitem[Ferreira et~al.(2020)Ferreira, Queiroz, Vinhas, Marujo, Simoes,
  Picoli, Camara, Cartaxo, Gomes, Santos, et~al.]{ferreira2021reproducible}
Ferreira, K.R.; Queiroz, G.R.; Vinhas, L.; Marujo, R.F.B.; Simoes, R.E.O.;
  Picoli, M.C.A.; Camara, G.; Cartaxo, R.; Gomes, V.C.F.; Santos, L.A.; et~al.
\newblock Earth Observation Data Cubes for {Brazil}: {R}equirements, Methodology
  and Products.
\newblock {\em Remote Sens.} {\bf 2020}, {\em 12},~4033.
\newblock {\url{https://doi.org/10.3390/rs12244033}}.
...
\bibitem[Romano and Zullo(2014)]{romano2017mediterranean}
Romano, B.; Zullo, F.
\newblock The urban transformation of {Italy}'s {Adriatic} coastal strip:
  {F}ifty years of unsustainability.
\newblock {\em Land Use Policy} {\bf 2014}, {\em 38},~26--36.
\newblock {\url{https://doi.org/10.1016/j.landusepol.2013.10.001}}.
...
\bibitem[Suanez et~al.(2012)Suanez, Cariolet, Cancou\"et, Ardhuin, and
  Delacourt]{suanez2012tempetes}
Suanez, S.; Cariolet, J.M.; Cancou\"et, R.; Ardhuin, F.; Delacourt, C.
\newblock Dune recovery after storm erosion on a high-energy beach: {V}ougot
  beach, {Brittany} ({France}).
\newblock {\em Geomorphology} {\bf 2012}, {\em 139--140},~16--33.
\newblock {\url{https://doi.org/10.1016/j.geomorph.2011.10.014}}.
...
%MDPI: Please add the page number. %AUTHOR: VertigO is an online-only journal; this article (Hors-série 10, 2011) has no page numbers. The DOI (10.4000/vertigo.11436) serves as the article identifier.
...
\newblock {\em VertigO---La revue électronique en sciences de l'environnement}
  {\bf 2011}, {\em Hors-série~10}.
\newblock {\url{https://doi.org/10.4000/vertigo.11436}}.

%MDPI: Please add the page number. %AUTHOR: VertigO is an online-only journal and this article (Hors-série 10, 2011) has no page numbers. The DOI (10.4000/vertigo.11576) has been added as the article identifier.
\bibitem[Femenias et~al.(2011)Femenias, Sirost, and Evrard]{femenias2011estuaire}
...
%MDPI: Please add the page number. %AUTHOR: La revue pour l'histoire du CNRS is an online-only journal; this article (issue 4, 2001) has no page numbers. The DOI (10.4000/histoire-cnrs.3182) serves as the article identifier.
...
\newblock {\em La revue pour l’histoire du CNRS} {\bf 2001}, {\em 4}.
